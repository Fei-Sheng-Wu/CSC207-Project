# CSC207 Project - "Suitable: Personal Outfit Advisor"

[![Java](https://img.shields.io/badge/Java-17-orange.svg?style=flat-square)](#)
[![Build](https://img.shields.io/badge/Build-Maven-green.svg?style=flat-square)](#)
[![License](https://img.shields.io/github/license/Fei-Sheng-Wu/CSC207-Project?label=License&style=flat-square)](LICENSE.txt)

> Suitable is a personalized outfit recommendation program that manages a user’s real-life wardrobe, providing tailored outfit styling suggestions based on weather, event, and user-created tags. It eases the everyday process of dressing up by curating new sets of clothes that the user can simply follow, respecting both aesthetic and functionality.
...
[![Contributors](https://contrib.rocks/image?repo=Fei-Sheng-Wu/CSC207-Project)](https://github.com/Fei-Sheng-Wu/CSC207-Project/graphs/contributors)
...
Suitable is licensed under the [MIT License](LICENSE.txt).
