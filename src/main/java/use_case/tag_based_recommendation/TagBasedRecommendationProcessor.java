 ...
 */
public class TagBasedRecommendationProcessor implements TagBasedRecommendationInputBoundary{
    ...
    public TagBasedRecommendationProcessor(
        Wardrobe wardrobe,
     ...
     */
    public void recommend(TagBasedRecommendationRequest request){
     ...
     */
    private String createResponse(TagBasedRecommendationRequest request){
        String response = "";
     ...
     */
    private boolean isBetter (AbstractWear candidate, AbstractWear current, TagBasedRecommendationRequest request){
        if(current == null){
            return true;
        }
        else{
     ...
     * @return score
     */
    private int calculateScore (AbstractWear item, TagBasedRecommendationRequest request){
        int score = 0;
